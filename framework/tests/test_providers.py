...
from agent_framework.llm.providers.openai_provider import OPENAI_BASE_URL


def test_openai_default_base_url_is_official_domain():
    """D1: 默认 base_url 必须是 OpenAI 官方域名（非拼写错误的 openseek）。"""
