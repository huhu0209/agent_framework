...
Plans:
- [x] 18-01-PLAN.md — Framework interface changes: @property + per-session ctx + working_dir + public methods (BK-LOGIC-03,04,05)
- [x] 18-02-PLAN.md — SessionManager async + atomic writes + TTL eviction fix (BK-LOGIC-01,02)
- [x] 18-03-PLAN.md — SSE error sanitization + CORS + session_id validation + Redis + SecretStr (BK-SEC-01~05)
